export default function SocialIcons() {
    const icons = [
        ...
        {
            name: "Academia",
            href: "https://independentresearcher.academia.edu/BenjaminBr%C3%A9cheteau",
            path: "M3.125 18.006c.453.208 1.166.273 1.166.273a.35.35 0 0 0 .362-.352c0-.186-.118-.283-.118-.283s-.292-.22-.323-1.011c-.022-.559.39-2.046.741-3.26l4.287-11.838c.451-.628.224-1.006.224-1.006S9.125 0 8.5 0C7.8 0 7.425.5 7.425.5S5.3 6.906 3.656 12.056c-.525 1.644-1.894 5.394-2.238 5.606 0 0 .544.256 1.707.344zm17.75 0c-.453.208-1.166.273-1.166.273a.35.35 0 0 1-.362-.352c0-.186.118-.283.118-.283s.292-.22.323-1.011c.022-.559-.39-2.046-.741-3.26l-4.288-11.838c-.45-.628-.223-1.006-.223-1.006S14.875 0 15.5 0c.7 0 1.075.5 1.075.5s2.125 6.406 3.769 11.556c.525 1.644 1.894 5.394 2.238 5.606 0 0-.544.256-1.707.344zM12 13.5c-3.1 0-3.6-1.5-3.6-1.5l-1.3-4.2h9.8l-1.3 4.2s-.5 1.5-3.6 1.5z"
        }
    ];
